 ...
 * {@code notifyItemInserted()}, etc. as appropriate.
 * <p>
...
public abstract class RealmRecyclerViewAdapter<T extends RealmModel, S extends RecyclerView.ViewHolder>
    ...
    /**
     * Ensure {@link #notifyDataSetChanged()} is only called once if a subclass also updated the
     * adapter data in a way that triggered {@link #notifyDataSetChanged()}.
     *
     * @return the offset to add to the index for Adapter notifications.
     */
